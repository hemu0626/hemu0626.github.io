...
## 2026 — Knowledge-augmented Survival Analysis and Bayesian Variable Selection

{% assign p26_pdf = site.static_files | where: "path", "/assets/surf/2026-knowledge-survival.pdf" | first %}
...
{% assign p25_pdf = site.static_files | where: "path", "/assets/surf/2025-breast-cancer.pdf" | first %}
...
{% assign p24_pdf = site.static_files | where: "path", "/assets/surf/2024-poisoning.pdf" | first %}
...
{% assign p23_pdf = site.static_files | where: "path", "/assets/surf/2023-dimred.pdf" | first %}
...
{% assign p22_pdf = site.static_files | where: "path", "/assets/surf/2022-psychometrics.pdf" | first %}
