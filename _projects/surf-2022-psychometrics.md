...
img: assets/img/surf-2022-thumb.jpg
importance: 6
category: work
...
{% if poster_png %}<p><img src="/assets/surf/2022-psychometrics.png" alt="SURF 2022 poster" style="width:70%;height:auto;"></p>{% endif %}
{% if poster_jpg %}<p><img src="/assets/surf/2022-psychometrics.jpg" alt="SURF 2022 poster" style="width:70%;height:auto;"></p>{% endif %}
